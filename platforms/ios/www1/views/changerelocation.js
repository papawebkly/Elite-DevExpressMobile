	...
	var viewModel = {
		...
		assignment_id: ko.observable(''),
   		...
   		viewShowing: function(){
					// To test on browser
						/*
        				email = "alan2@notionlabs.com";
        				auth_token = "82fjPCRe_g59Vfo8zBnQ";
	                    localStorage.setItem("selected_assignmentid", "");
	                    localStorage.setItem("selected_assignment", "");
	                    localStorage.setItem("auth_token", auth_token);
	                    localStorage.setItem("employee_id", "24752");
			    		localStorage.setItem("elite_email", email);
			    		localStorage.setItem("elite_pwd", "drpepper");
			    		
                        API_EMPOLOYEES = API_EMPOLOYEES.replace("EMPLOYEE_ID", 24752);
