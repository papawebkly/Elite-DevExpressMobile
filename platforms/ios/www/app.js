...
$(function() {
  ...
  alert(e.viewInfo.viewName);
    ...
    function onDeviceReady() {
        ...
        var htmltag = '<center id="menu_full_name" style="color:white; position:absolute; top:60px; width:33%; margin-left:33%;"></center>'
  
        //document.getElementById("full_name").remove();
        $('.dx-slideout-menu .dx-scrollable-container').append(htmltag);
    ...
    //Elite.app.navigate('banklist', { root: true });
});
