...
function formatDate(date) {
    ...
    var ret = curr_date + "th " + months[curr_month] + " " + curr_year;
    return ret;
}
...
function goPolicy(){
	...
	console.log(API_PRIVACY_POLICY);
    go_url(API_PRIVACY_POLICY);
...
function set_menus(assignment_id, go_home){
    ...
    document.getElementById("menu_full_name").innerHTML = full_name;

	var fromto=localStorage.getItem("fromto");
	document.getElementById("menu_home").innerHTML = fromto;
}
function onOffline(){
